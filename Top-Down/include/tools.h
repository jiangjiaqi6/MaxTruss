...
#define AMOUNT(x) (uint32_t(x & 0x000FFFFF))
#define TIMESTAMP(x) (uint64_t(x >> 20u))

#define LEFT 0x8000000000000000
#define DELETE(x) (x | 0x80000000)
#define RESTORE(x) (x & 0x7FFFFFFF)
#define MOVE(x) (x >> 31u)
#define COMBINE(x,y) ((uint64_t(x) << 32) | y)
// #define MEM 3000000  // edges
...
constexpr uint32_t INF_U32 = 4294967295;
